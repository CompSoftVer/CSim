...
theory VcgCon
imports StateSpace "~~/src/HOL/Statespace/StateSpaceLocale" Generalise SmallStepCon
...
syntax
  ...
  "_Await" :: "'a bexp \<Rightarrow> ('a,'p,'f) com \<Rightarrow>('a,'p,'f) com"
        ("(0AWAIT (_)/ _)" [0, 0] 71)
  "_GuardedAwait" :: "'a bexp \<Rightarrow> ('a,'p,'f) com \<Rightarrow>('a,'p,'f) com"
...
translations
  ...
  "{|b|}r" => "(CONST image ((CONST case_prod (CONST to_normal))) ({| b |}))"
